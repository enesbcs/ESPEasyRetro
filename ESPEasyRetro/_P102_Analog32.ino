...
#define P102_MODE_OPTION 3
    ...
    case PLUGIN_TEN_PER_SECOND:
      {
        if ((Settings.TaskDevicePluginConfig[event->TaskIndex][1]) && (Settings.TaskDeviceTimer[event->TaskIndex] == 0)) //Binary sensor
        {
    ...
    case PLUGIN_READ:
      {
        ...
        if (Settings.TaskDevicePluginConfig[event->TaskIndex][1])   //Binary sensor
        {
          if (value > Settings.TaskDevicePluginConfig[event->TaskIndex][2] && value < Settings.TaskDevicePluginConfig[event->TaskIndex][3]) {
